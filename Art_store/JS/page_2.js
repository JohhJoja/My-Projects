...
window.addEventListener('scroll', (e) => {
    if (parseFloat(second_part.getBoundingClientRect().top) < 80) {
        ...
        menu_circle.style.cssText = `background:url('../img/page_2/menu_red.png') center/cover no-repeat;`
            // menu_circle_2.style.zIndex = 20;
            // first_part.style.zIndex = 0;
    } else {
        menu_circle.style.cssText = `background:url('../img/page_2/menu.png') center/cover no-repeat;`
